...
public:
    ...
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget) override{
        ...
        painter->setFont(QFont(("宋体"),13,10));
        //painter->drawText(QRectF(15,25,80,80),"阳光：");
        painter->drawImage(QRectF(200,10,80,80),QImage(":/image/Sun.gif"));
        painter->setPen(Qt::yellow);
        painter->drawText(QRectF(280,35,80,80),QString::number(sun));

        painter->drawImage(QRectF(50,10,80,80),QImage(":/image/HP.png"));
        painter->setPen(Qt::red);
        painter->setFont(QFont(("宋体"),18,15));
        painter->drawText(QRectF(130,25,80,80),QString::number(gameHP));
